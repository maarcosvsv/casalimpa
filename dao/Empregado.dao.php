...
class EmpregadoDAO {
 ...
 function incluirEmpregador($usuario, $nome, $telefoneCompleto, $dataNascimento) {
   ...
   function salvarEmpregadoEmpregador($empregado, $nome, $telefoneCompleto, $dataNascimento) {
         $connectionFactory = new connectionFactory();
         $connection = $connectionFactory->getConnection();
      ...
      //echo mysql_errno($connection) . ": " . mysql_error($connection) . "\n";
		 ...
		 $sqlInsertCliente = "insert into cliente (nome, telefone, data_nascimento,  id_usuario) "
                 . "values ('".$nome."','".$telefoneCompleto."','".$dataNascimento."',".$idUsuario.")";  
           
        mysql_query($sqlInsertCliente, $connection); 
        ...
        if($errorCliente == "0" && $errorProfissional == "0" && $errorUsuario == "0"){
            return true;
        }else{
            return false;
        }
